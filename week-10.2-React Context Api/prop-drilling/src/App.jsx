...
//     <Light bulbState = {bulbState} setBulbState = {setBulbState}/>
//     </>
//   )
// }

// function Light({bulbState,setBulbState}){

//   return <>

 
//   <BulbState setBulbState={setBulbState}/>
//   <ToggleBulbState setBulbState={setBulbState}/>

//   </>
// }

// // function LightBulb({bulbState, setBulbState}){
// //   // const [bulbState, setBulbState] = useState(true);
